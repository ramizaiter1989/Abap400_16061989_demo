CLASS zcl_16061989_data_objects DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_16061989_data_objects IMPLEMENTATION.
...
**********************************************************************
    ...
    "Uncomment this line to see syntax error ( VALUE is mandatory)
     CONSTANTS c_text2   type string VALUE 12356756745.
...
**********************************************************************
    ...
    out->write(  c_text2 ).    "Text Literal   (Type C)
